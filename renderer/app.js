...
async function createInstance() {
  ...
  const folderName=name.replace(/[^a-zA-Z0-9 _-]/g,'').replace(/\s+/g,'_').slice(0,40)||_id;
  const instance={ id:_id, name,mcVersion,loader,loaderVersion,mods:0,folderName,createdAt:new Date().toISOString() };
